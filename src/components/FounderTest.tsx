          ...
          <div className="founder-grid">
            ...
            <div>
              ...
              <Reveal as="p" className="founder-bio" delay={80}>
                ...
                <br />
                <br />
                <strong>Most agencies come at outbound from sales. We come at it from engineering - and in 2026, that&apos;s where the hard problems actually live.</strong>
              </Reveal>
