...
const MACHINE_SVG = `
      ...
      <g class="drop-env" style="animation-delay:-2.66s"><rect width="16" height="11" rx="2" fill="#f5a623"/><g stroke="#fff" stroke-width="1" fill="none"><rect x="3" y="3.5" width="6" height="4.5" rx="0.6"/><path d="M9 5h1.7l1.4 1.4V8H9z"/></g><circle cx="4.8" cy="9" r="0.8" fill="#fff"/><circle cx="10.3" cy="9" r="0.8" fill="#fff"/></g>
      ...
      <g class="hero-env" style="--d:0s">
        ...
        <rect width="30" height="20" rx="3" fill="#ff5b56"/>
        <rect x="7" y="6" width="16" height="10" rx="1.5" fill="none" stroke="#fff" stroke-width="1.5"/>
        <path d="M7.5 6.7 L15 12 L22.5 6.7" fill="none" stroke="#fff" stroke-width="1.5"/>
      ...
      <div className="sec dark">
        <div className="sec-inner" style={{ textAlign: "center" }}>
          ...
          <Reveal as="p" className="sec-sub" delay={80} style={{ maxWidth: 560, marginLeft: "auto", marginRight: "auto" }}>
            We run outreach across email, LinkedIn, and direct mail — but email is where most agencies quietly break. Landing in the primary inbox, at scale, without burning domains is an engineering problem. Here&apos;s the system we run on every account - monitored, instrumented, and tuned like a production pipeline.
          </Reveal>
          ...
          >
            ...
            <span style={{ color: "#6a7192", fontSize: 12.5, fontFamily: "'JetBrains Mono', ui-monospace, monospace" }}>
              → one engine ↓
            </span>
          </Reveal>

          <div className="machine">
            <svg viewBox="0 0 820 250" role="img" aria-label="Bleed AI multi-channel engine" dangerouslySetInnerHTML={{ __html: MACHINE_SVG }} />
          </div>
