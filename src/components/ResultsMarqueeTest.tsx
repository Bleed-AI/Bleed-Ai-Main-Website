...
export default function ResultsMarqueeTest() {
  return (
      ...
      <div className="sec dark">
        <div className="sec-inner">
          ...
          <Reveal as="p" className="sec-sub" delay={80}>
            Real campaigns, real clients, real data. These aren&apos;t cherry-picked outliers - they&apos;re what happens when outbound is engineered, not improvised.
          </Reveal>
