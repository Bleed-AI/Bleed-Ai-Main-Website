...
export default function VsTableTest() {
  return (
      ...
      <div className="sec dark">
        <div className="sec-inner">
          ...
          <Reveal as="p" className="sec-sub" delay={80}>
            Most agencies hire salespeople who got good at outbound. We were built by an AI engineer, and that one difference changes what happens at every step. Here&apos;s the before and after, point by point.
          </Reveal>
