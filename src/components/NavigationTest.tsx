...
// Clone of Navigation.tsx with one structural change:
// `fixed top-0` → `sticky top-0` so it sits below the topbar ticker
// at the top of the page, then locks to viewport top on scroll.
